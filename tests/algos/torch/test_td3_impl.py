...
def test_td3_impl(observation_shape, action_size, actor_learning_rate,
                  ...
                  critic_optim_factory, encoder_factory, q_func_factory, gamma,
                  tau, reguralizing_rate, n_critics, bootstrap, share_encoder,
                  target_smoothing_sigma, target_smoothing_clip, scaler,
                  augmentation):

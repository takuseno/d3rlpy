...
def test_plas_impl(observation_shape, action_size, actor_learning_rate,
                   ...
                   gamma, tau, n_critics, bootstrap, share_encoder, lam, beta,
                   scaler, augmentation):
    impl = PLASImpl(observation_shape,
                    action_size,
                    actor_learning_rate,
...
def test_plas_with_perturbation_impl(
        ...
        critic_learning_rate, imitator_learning_rate, actor_optim_factory,
        critic_optim_factory, imitator_optim_factory, encoder_factory,
        q_func_factory, gamma, tau, n_critics, bootstrap, share_encoder, lam,
        beta, action_flexibility, scaler, augmentation):
    impl = PLASWithPerturbationImpl(observation_shape,
                                    action_size,
                                    actor_learning_rate,
                                    critic_learning_rate,
                                    imitator_learning_rate,

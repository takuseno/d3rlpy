...
def test_pixel_encoder(shapes, filters, feature_size, batch_size,
                       use_batch_norm, activation):
    observation_shape, linear_input_size = shapes

    encoder = PixelEncoder(observation_shape, filters, feature_size,
                           use_batch_norm, activation)
...
@pytest.mark.parametrize('activation', [torch.relu])
def test_pixel_encoder_with_action(shapes, action_size, filters, feature_size,
                                   batch_size, use_batch_norm, discrete_action,
                                   activation):
    observation_shape, linear_input_size = shapes

    encoder = PixelEncoderWithAction(observation_shape, action_size, filters,

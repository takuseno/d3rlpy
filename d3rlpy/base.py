...
from .torch_utility import Checkpointer, Modules, TorchMiniBatch
...
class LearnableConfig(DynamicConfig):
    ...
    transform: Optional[Callable[[TorchMiniBatch], TorchMiniBatch]] = make_transformation_callable_field()
